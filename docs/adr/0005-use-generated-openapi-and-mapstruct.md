...
Use springdoc-openapi to expose runtime API documentation and a Maven profile named `generate-openapi` to export `openapi.json` during the documentation workflow.
