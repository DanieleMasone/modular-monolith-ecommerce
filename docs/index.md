...
- [CI and GitHub Pages](ci-and-pages.md)
- [Testing](testing.md)
- [Architecture Decision Records](adr/)
- [ADR 0001: Use Modular Monolith](adr/0001-use-modular-monolith.md)
- [ADR 0002: Use Spring Events for Internal Communication](adr/0002-use-spring-events-for-internal-communication.md)
